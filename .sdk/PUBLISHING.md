...
|---|---|---|
| `ts/` | @voxgig-sdk/star-wars-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/star-wars-sdk \
      --repository voxgig-sdk/star-wars-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/star-wars-sdk` shows it, and
`npm trust revoke @voxgig-sdk/star-wars-sdk --id=<id>` removes it.
