...
class StarWarsFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; StarWarsSDK/1.0)';
    ...
    public static function call(StarWarsContext $ctx, string $fullurl, array $fetchdef): array
    {
