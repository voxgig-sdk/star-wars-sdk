...
class StarWarsNetsimFeature extends StarWarsBaseFeature
{
    ...
    private function _simulate(StarWarsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(StarWarsContext $ctx, array $applied): void
    {
        $client = $this->client;
