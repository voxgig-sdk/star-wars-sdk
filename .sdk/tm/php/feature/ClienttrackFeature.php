...
// StarWars SDK clienttrack feature
...
class StarWarsClienttrackFeature extends StarWarsBaseFeature
{
    ...
    public function PostConstruct(StarWarsContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'StarWars-SDK';
