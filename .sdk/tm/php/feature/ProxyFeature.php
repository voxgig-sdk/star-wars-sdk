...
class StarWarsProxyFeature extends StarWarsBaseFeature
{
    ...
    public function init(StarWarsContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (StarWarsContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
