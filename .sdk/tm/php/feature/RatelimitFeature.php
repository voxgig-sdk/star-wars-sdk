...
// StarWars SDK ratelimit feature
...
class StarWarsRatelimitFeature extends StarWarsBaseFeature
{
    ...
    private function _acquire(StarWarsContext $ctx): void
    {
    ...
    private function _track(StarWarsContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
