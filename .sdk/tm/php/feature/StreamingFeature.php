...
// StarWars SDK streaming feature
...
class StarWarsStreamingFeature extends StarWarsBaseFeature
{
    ...
    private function _iterate(StarWarsResult $result): \Generator
    {
    ...
    private function _streamable(StarWarsContext $ctx): bool
    {
