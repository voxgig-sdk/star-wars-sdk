...
// StarWars SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class StarWarsTestFeature extends StarWarsBaseFeature
{
    ...
    public function init(StarWarsContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (StarWarsContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (StarWarsContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(StarWarsContext $ctx, $op, $args): array
    {
