...
// StarWars SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = StarWarsOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(StarWarsOmni::structfix($now, Struct::undef()))
                        !== json_encode(StarWarsOmni::structfix($val, Struct::undef()))) {
