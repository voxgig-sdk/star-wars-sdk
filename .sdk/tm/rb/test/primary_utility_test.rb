...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = StarWarsOmni.make_runner(TEST_JSON_FILE, StarWarsSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : StarWarsOmni.errify(err)
    end
