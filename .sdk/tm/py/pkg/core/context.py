...
from projectname_sdk.core.control import StarWarsControl
...
class StarWarsContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(r, StarWarsResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, StarWarsResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return StarWarsError(code, msg, self)
