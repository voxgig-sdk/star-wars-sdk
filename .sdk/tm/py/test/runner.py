...
class StarWarsTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = StarWarsTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = StarWarsTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = StarWarsTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
