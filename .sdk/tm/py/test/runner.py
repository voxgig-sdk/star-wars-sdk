...
class StarWarsTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = StarWarsTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = StarWarsTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = StarWarsTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
