...
from projectname_sdk import StarWarsSDK
from projectname_sdk.core.spec import StarWarsSpec
from projectname_sdk.core.result import StarWarsResult
from projectname_sdk.core.response import StarWarsResponse
from projectname_sdk.core.operation import StarWarsOperation
from projectname_sdk.core.error import StarWarsError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import StarWarsBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = StarWarsSDK.test(None, None)
        ...
        class TestInitFeature(StarWarsBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(StarWarsBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = StarWarsSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = StarWarsSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = StarWarsSDK.test(None, setup_opts)
