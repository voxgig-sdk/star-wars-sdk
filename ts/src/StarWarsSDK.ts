...
class StarWarsSDK {
  ...
  async graphql(query: string, variables?: any, ctrl?: any) {
    ...
    if (null != errors && Array.isArray(errors) && 0 < errors.length) {
      ...
      const err: any = new Error('StarWarsSDK: graphql: ' +
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  Planet(entopts?: Record<string, any>) {
    const self = this
    return new PlanetEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  Species(entopts?: Record<string, any>) {
    const self = this
    return new SpeciesEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  Starship(entopts?: Record<string, any>) {
    const self = this
    return new StarshipEntity(self, entopts)
  }
