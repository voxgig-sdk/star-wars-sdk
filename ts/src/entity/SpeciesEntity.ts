...
class SpeciesEntity extends StarWarsEntityBase<Species> {
  ...
  make(this: SpeciesEntity) {
    return new SpeciesEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: SpeciesLoadMatch, ctrl?: Control): Promise<SpeciesEntity> {
