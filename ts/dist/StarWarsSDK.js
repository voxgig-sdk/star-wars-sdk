...
const StarshipEntity_1 = require("./entity/StarshipEntity");
...
Object.defineProperty(exports, "StarWarsEntityBase", { enumerable: true, get: function () { return StarWarsEntityBase_1.StarWarsEntityBase; } });
...
class StarWarsSDK {
    ...
    async direct(fetchargs) {
        if (!this._options.allow.op.includes('direct')) {
            return {
                ok: false,
                err: new Error('StarWarsSDK: direct: operation not allowed by' +
    ...
    async graphql(query, variables, ctrl) {
        ...
        if (!options.allow.op.includes('graphql')) {
            return {
                ok: false,
                err: new Error('StarWarsSDK: graphql: operation not allowed by' +
        ...
        if (null != errors && Array.isArray(errors) && 0 < errors.length) {
            ...
            const err = new Error('StarWarsSDK: graphql: ' +
    ...
    Planet(entopts) {
        const self = this;
        return new PlanetEntity_1.PlanetEntity(self, entopts);
    }
    ...
    Species(entopts) {
        const self = this;
        return new SpeciesEntity_1.SpeciesEntity(self, entopts);
    }
    ...
    Starship(entopts) {
        const self = this;
        return new StarshipEntity_1.StarshipEntity(self, entopts);
    }
    ...
    static test(testoptsarg, sdkoptsarg) {
        ...
        const testsdk = new StarWarsSDK(sdkopts);
        testsdk._mode = 'test';
        return testsdk;
    }
    tester(testopts, sdkopts) {
        return StarWarsSDK.test(testopts, sdkopts);
    }
    toJSON() {
        return { name: 'StarWars' };
    }
    toString() {
        return 'StarWars ' + this._utility.struct.jsonify(this.toJSON());
    }
    [node_util_1.inspect.custom]() {
        return this.toString();
    }
}
exports.StarWarsSDK = StarWarsSDK;
const SDK = StarWarsSDK;
exports.SDK = SDK;
//# sourceMappingURL=StarWarsSDK.js.map