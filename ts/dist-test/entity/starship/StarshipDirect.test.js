...
(0, node_test_1.describe)('StarshipDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-starship', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-starship', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-starship', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-starship', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['STAR_WARS_TEST_STARSHIP_ENTID'];
...
//# sourceMappingURL=StarshipDirect.test.js.map