...
class PlanetEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new PlanetEntity($this->_client, $opts);
    }

    /**
     * @param Planet|array $args Planet data (assoc-array) to store.
     */
    ...
    /**
     * @return Planet|array The current Planet data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Planet fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Planet fields).
     */
     ...
     *
     * @param PlanetLoadMatch|array|null $reqmatch Match criteria (id/query
    ...
    /**
     * List Planet items matching the given filter.
     *
     * @param PlanetListMatch|array|null $reqmatch Match filter (any subset
