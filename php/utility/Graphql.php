...
class StarWarsGraphql
{
    ...
    // equivalent.
    public static function body(StarWarsContext $ctx): mixed
    {
    ...
    public static function errors(StarWarsContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
