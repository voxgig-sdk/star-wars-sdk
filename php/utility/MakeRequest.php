...
// StarWars SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class StarWarsMakeRequest
{
    public static function call(StarWarsContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new StarWarsResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new StarWarsResponse($fetched);
        } else {
