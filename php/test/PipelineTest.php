...
{
    private static function utility(): StarWarsUtility
    {
        return new StarWarsUtility();
    }
    ...
    private static function ctx(array $over = []): StarWarsContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new StarWarsContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new StarWarsOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof StarWarsError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new StarWarsOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = StarWarsMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new StarWarsOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = StarWarsMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new StarWarsOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = StarWarsMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new StarWarsSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = StarWarsMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            ...
            'result' => new StarWarsResult([]),
        ]);
        [, $err] = StarWarsMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new StarWarsSpec([]),
            'response' => null,
            'result' => new StarWarsResult([]),
        ]);
        [, $err] = StarWarsMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new StarWarsSpec(['step' => 's']),
            'response' => new StarWarsResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new StarWarsResult([]),
        ]);
        [, $err] = StarWarsMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new StarWarsSpec(['step' => 's']),
            'response' => new StarWarsResponse(self::resp(200, ['v' => 1])),
            'result' => new StarWarsResult([]),
        ]);
        [, $err] = StarWarsMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new StarWarsSpec(['step' => 's']),
            'response' => new StarWarsResponse(self::resp(200, ['v' => 2])),
            'result' => new StarWarsResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        StarWarsMakeResponse::call($ctx);
    ...
    {
        $preset = new StarWarsResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new StarWarsSpec([]),
            'response' => new StarWarsResponse([]),
            'result' => new StarWarsResult([]),
        ...
        [$got, $err] = StarWarsMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new StarWarsResult([])]);
        [, $err] = StarWarsMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new StarWarsSpec([]), 'result' => null]);
        [, $err] = StarWarsMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new StarWarsSpec(['step' => 's']),
            'result' => new StarWarsResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new StarWarsOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = StarWarsMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new StarWarsSpec(['step' => 's']),
            'result' => new StarWarsResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new StarWarsOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = StarWarsMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new StarWarsResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new StarWarsSpec([]),
            'result' => new StarWarsResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = StarWarsMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = StarWarsMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new StarWarsError('boom', 'boom');
        $utility->fetcher = function (StarWarsContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new StarWarsSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = StarWarsMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (StarWarsContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = StarWarsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(StarWarsResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (StarWarsContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new StarWarsSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = StarWarsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new StarWarsResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new StarWarsSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = StarWarsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = StarWarsMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = StarWarsMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new StarWarsResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, StarWarsDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new StarWarsResult(['ok' => false])]);
        $this->expectException(StarWarsError::class);
        StarWarsDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new StarWarsResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', StarWarsMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        StarWarsMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new StarWarsBaseFeature();
        $b = new StarWarsBaseFeature();
        StarWarsFeatureAdd::call($ctx, $a);
        StarWarsFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): StarWarsBaseFeature
    {
        $f = new StarWarsBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        StarWarsFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): StarWarsContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new StarWarsSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = StarWarsPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new StarWarsResponse(['headers' => null]),
            'result' => new StarWarsResult([]),
        ]);
        StarWarsResultHeaders::call($ctx);
