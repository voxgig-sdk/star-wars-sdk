...
// StarWars SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (StarWarsSDK::test)
...
{
    private const SDK_CLASS = 'StarWarsSDK';
    ...
    private const SDK_BASE = 'starwars_sdk';
