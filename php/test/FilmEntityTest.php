...
class FilmEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set STAR_WARS_TEST_FILM_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function film_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("STAR_WARS_TEST_FILM_ENTID");
