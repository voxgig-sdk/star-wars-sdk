...
class StarWarsRbacFeature extends StarWarsBaseFeature
{
    ...
    private function _required(StarWarsContext $ctx): ?string
    {
    ...
    private function _reject(StarWarsContext $ctx, string $required): void
    {
    ...
    private function _track(StarWarsContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
