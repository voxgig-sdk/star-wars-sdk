...
class StarWarsCacheFeature extends StarWarsBaseFeature
{
    ...
    private function _through(StarWarsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
