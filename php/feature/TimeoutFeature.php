...
class StarWarsTimeoutFeature extends StarWarsBaseFeature
{
    ...
    private function _with_timeout(StarWarsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(StarWarsContext $_ctx, float $ms): void
    {
        $client = $this->client;
