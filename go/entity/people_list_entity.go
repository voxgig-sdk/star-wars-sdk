...
func NewPeopleListEntity(client *core.StarWarsSDK, entopts map[string]any) *PeopleListEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PeopleListEntity) GetName() string { return e.name }
...
func (e *PeopleListEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PeopleListEntity) Deleted() bool {
	return e.deleted
}


func (e *PeopleListEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPeopleListEntity(e.client, opts)
}

func (e *PeopleListEntity) Data(args ...any) any {
...
func (e *PeopleListEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *PeopleListEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PeopleListEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *PeopleListEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PeopleListEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PeopleListEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PeopleListEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
