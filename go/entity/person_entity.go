...
func NewPersonEntity(client *core.StarWarsSDK, entopts map[string]any) *PersonEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PersonEntity) GetName() string { return e.name }
...
func (e *PersonEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PersonEntity) Deleted() bool {
	return e.deleted
}


func (e *PersonEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPersonEntity(e.client, opts)
}

func (e *PersonEntity) Data(args ...any) any {
...
func (e *PersonEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Person; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PersonEntity) DataTyped(data ...Person) Person {
	if len(data) > 0 {
		return typedFrom[Person](e.Data(asMap(data[0])))
	}
	return typedFrom[Person](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Person (all fields
// optional at the wire level).
func (e *PersonEntity) MatchTyped(match ...Person) Person {
	if len(match) > 0 {
		return typedFrom[Person](e.Match(asMap(match[0])))
	}
	return typedFrom[Person](e.Match())
}
...
func (e *PersonEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PersonEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PersonLoadMatch and returns an Person. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *PersonEntity) LoadTyped(reqmatch PersonLoadMatch, ctrl map[string]any) (Person, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Person{}, err
	}
	return typedFrom[Person](res), nil
}




func (e *PersonEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// PersonListMatch and returns []Person. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *PersonEntity) ListTyped(reqmatch PersonListMatch, ctrl map[string]any) ([]Person, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Person](res), nil
}



func (e *PersonEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PersonEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PersonEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PersonEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
