...
The Golang SDK for the StarWars API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/star-wars-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/star-wars-sdk=../path/to/github.com/voxgig-sdk/star-wars-sdk
```
...
```
github.com/voxgig-sdk/star-wars-sdk/
...
The root package (`github.com/voxgig-sdk/star-wars-sdk`) re-exports everything needed
