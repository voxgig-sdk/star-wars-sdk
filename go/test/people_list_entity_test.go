...
func TestPeopleListEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if setup.syntheticOnly {
			t.Skip("live entity test uses synthetic IDs from fixture — set STARWARS_TEST_PEOPLE_LIST_ENTID JSON to run live")
			return
		}
...
func people_listBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("STARWARS_TEST_PEOPLE_LIST_ENTID")
