...
const testSeed = `map[string]any{"entity": map[string]any{"film": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "people_list": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "person": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "planet": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "species": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "starship": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "vehicle": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
