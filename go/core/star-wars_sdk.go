...
func (sdk *StarWarsSDK) OptionsMap() map[string]any {
...
func (sdk *StarWarsSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *StarWarsSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *StarWarsSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *StarWarsSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *StarWarsSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *StarWarsSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("StarWarsSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *StarWarsSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *StarWarsSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("StarWarsSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
