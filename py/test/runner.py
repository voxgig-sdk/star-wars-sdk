...
class StarWarsTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = StarWarsTestRunner.getenv("STARWARS_TEST_LIVE")
        override = StarWarsTestRunner.getenv("STARWARS_TEST_OVERRIDE")
        ...
        explain = StarWarsTestRunner.getenv("STARWARS_TEST_EXPLAIN")
        if explain is not None and explain != "":
            m["STARWARS_TEST_EXPLAIN"] = explain
