# StarWars SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions StarWarsSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both StarWarsSDK(...) and StarWarsSDK.test(...) become
#      StarWarsSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "starwars_sdk"
_SDK_CLASS = "StarWarsSDK"
