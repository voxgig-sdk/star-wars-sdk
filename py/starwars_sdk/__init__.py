...
from starwars_sdk.utility import register

# Load features
from starwars_sdk.feature.base_feature import StarWarsBaseFeature
from starwars_sdk.features import _has_feature, _make_feature
...
class StarWarsSDK:
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("StarWarsSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Starship(self, data=None) -> "StarshipEntity":
        ...
        from starwars_sdk.entity.starship_entity import StarshipEntity
    ...
    def Vehicle(self, data=None) -> "VehicleEntity":
        ...
        from starwars_sdk.entity.vehicle_entity import VehicleEntity
