...
type Args struct {
	Entity string         `json:"entity" jsonschema:"film | people_list | person | planet | species | starship | vehicle"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.StarWarsSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "star-wars_list",
		Description: "List records from StarWars. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "star-wars_load",
		Description: "Load a single record from StarWars. " +
...
func runOp(client *sdk.StarWarsSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.StarWarsSDK, name string) (sdk.StarWarsEntity, error) {
	switch strings.ToLower(name) {
	case "film":
		return client.Film(nil), nil
	case "people_list":
		return client.PeopleList(nil), nil
	case "person":
		return client.Person(nil), nil
	case "planet":
		return client.Planet(nil), nil
	case "species":
		return client.Species(nil), nil
	case "starship":
		return client.Starship(nil), nil
	case "vehicle":
