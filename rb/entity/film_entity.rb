...
class FilmEntity
  ...
  # @return [Film, Hash] the loaded Film; raises StarWarsError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Film>, Array] the matching Film items; raises StarWarsError on failure
