...
class PersonEntity
  ...
  #   as an empty match, so client.Person.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Person, Hash] the loaded Person; raises StarWarsError on failure
  ...
  #
  # @param reqmatch [PersonListMatch, Hash, nil] match filter (any subset of
  #   Person fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Person>, Array] the matching Person items; raises StarWarsError on failure
