...
class VehicleEntity
  ...
  #
  # @param reqmatch [VehicleLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Vehicle.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Vehicle, Hash] the loaded Vehicle; raises StarWarsError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Vehicle>, Array] the matching Vehicle items; raises StarWarsError on failure
