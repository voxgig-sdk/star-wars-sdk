...
class PeopleListEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set STAR_WARS_TEST_PEOPLE_LIST_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def people_list_basic_setup(extra)
  ...
  entid_env_raw = ENV["STAR_WARS_TEST_PEOPLE_LIST_ENTID"]
