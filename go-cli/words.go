...
func registerSDKWords(r *eng.Registry, client *sdk.StarWarsSDK) {
...
func runOp(client *sdk.StarWarsSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
