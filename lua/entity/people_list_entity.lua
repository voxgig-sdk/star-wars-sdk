...
local PeopleListEntity = {}
PeopleListEntity.__index = PeopleListEntity


function PeopleListEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, PeopleListEntity)
  self._name = "people_list"
  self._client = client
...
function PeopleListEntity:get_name()
  return self._name
end


function PeopleListEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return PeopleListEntity.new(self._client, opts)
end
...
function PeopleListEntity:mark_deleted()
  self._deleted = true
end


function PeopleListEntity:deleted()
  return true == self._deleted
end


function PeopleListEntity:data_set(args)
  if args ~= nil then
...
function PeopleListEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function PeopleListEntity:match_set(args)
  if args ~= nil then
...
function PeopleListEntity:match_get()
...
function PeopleListEntity:stream(action, args, callopts)
...
function PeopleListEntity:_run_op(ctx, post_done)
  local utility = self._utility
