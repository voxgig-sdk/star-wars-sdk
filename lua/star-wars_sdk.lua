...
local StarWarsSDK = {}
StarWarsSDK.__index = StarWarsSDK
...
StarWarsSDK._make_feature = _make_feature


function StarWarsSDK.new(options)
  local self = setmetatable({}, StarWarsSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function StarWarsSDK:options_map()
...
function StarWarsSDK:get_utility()
  return Utility.copy(self._utility)
end


function StarWarsSDK:get_root_ctx()
  return self._rootctx
end


function StarWarsSDK:prepare(fetchargs)
...
function StarWarsSDK:direct(fetchargs)
...
-- by passing it.
function StarWarsSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function StarWarsSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "StarWarsSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function StarWarsSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = StarWarsSDK.new(sdkopts)
  sdk.mode = "test"
