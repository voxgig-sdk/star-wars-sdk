...
describe("StarshipDirect", function()
  it("should direct-list-starship", function()
    local setup = starship_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-starship", setup.live and "live" or "unit")
  ...
  it("should direct-load-starship", function()
    local setup = starship_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-starship", setup.live and "live" or "unit")
    if _should_skip then
      pending(_reason or "skipped via sdk-test-control.json")
      return
    end
...
function starship_direct_setup(mockres)
